...
> This is not the CFScript syntax documentation you're (possibly) looking for; though it's highly recommended as a reference to the content you'll find here. That awesome piece of work, by Adam Cameron, can be found [here](https://github.com/adamcameron/cfscript).
